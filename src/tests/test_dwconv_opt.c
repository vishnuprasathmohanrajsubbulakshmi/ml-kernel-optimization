#include <stdio.h>
#include <stdint.h>
#include "optimized/dwconv_int8_opt.h"
...
int main(void) {
    ...
    dwconv2d_int8_opt(input, kernel, bias, output,
    ...
    if (pass) {
        printf("PASS: dwconv2d_int8_opt output is correct.\n");
        return 0;
    } else {
        printf("FAIL: dwconv2d_int8_opt output is incorrect.\n");
        return 1;
    }
}
